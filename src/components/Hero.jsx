    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#f5f6fa] via-white to-indigo-50/60 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/30 grid-pattern section-glow">
      ...
      <div ref={ref} className={`relative z-10 text-center px-6 ${isRevealed ? 'fade-in-up' : 'opacity-0'}`}>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 justify-center">
          ...
          <a href="mailto:danishpatel5106@gmail.com" className="text-gray-400 dark:text-gray-500 hover:text-indigo-500 dark:hover:text-indigo-400 transition-all duration-300 flex items-center gap-2 hover:scale-105 min-w-0">
            ...
            <span className="text-sm md:text-base truncate">danishpatel5106@gmail.com</span>
          </a>
        </div>
      </div>
